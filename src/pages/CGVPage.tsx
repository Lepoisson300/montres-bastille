            ...
            <div className="md:col-span-8 lg:col-span-9 space-y-16">
              ...
              <Reveal>
                <article id="art3">
                  ...
                  <div className="text-text-muted font-sans leading-relaxed space-y-4">
                    <p>Les prix de nos montres sont indiqués en euros (€). [Toutes Taxes Comprises (TTC) / TVA non applicable, art. 293 B du CGI]. Les frais de livraison sont facturés en supplément et indiqués avant la validation finale de la commande.</p>
                    <p>Le paiement est exigible immédiatement à la commande. Pour vous garantir une sécurité absolue, les transactions sont intégralement gérées par notre partenaire financier <strong>Stripe</strong>.</p>
                    <ul className="list-disc pl-5 space-y-2 mt-2">
                      <li>Les paiements par carte bancaire sont chiffrés de bout en bout selon la norme de sécurité maximale (PCI-DSS de niveau 1).</li>
                      <li><strong>Aucune coordonnée bancaire ne transite ni n'est stockée</strong> sur les serveurs de {companyInfo.companyName}.</li>
                    </ul>
                  </div>
                </article>
              </Reveal>
