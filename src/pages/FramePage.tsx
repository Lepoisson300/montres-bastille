      ...
      <div className="absolute top-0 left-0 w-full z-10 pointer-events-none">
        ...
        <div className="h-screen flex items-center justify-center">
          <div className="mx-[10%]">
            ...
            <h1 className="mt-4 mb-3 text-center text-4xl md:text-8xl font-serif text-text-primary leading-tight tracking-tight">
              Montres-Bastille
            </h1>
             <p className="tracking-[.25em] text-[10px] md:text-xl uppercase text-accent font-sans mb-3 text-center">
