...
var createDomVisualElement = (Component3, options) => {
  return isSVGComponent(Component3) ? new SVGVisualElement(options) : new HTMLVisualElement(options, {
    allowProjection: Component3 !== import_react12.Fragment
  });
};
...
function MeasureLayout(props) {
  ...
  return (0, import_jsx_runtime7.jsx)(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: (0, import_react13.useContext)(SwitchLayoutGroupContext), isPresent: isPresent2, safeToRemove });
}
